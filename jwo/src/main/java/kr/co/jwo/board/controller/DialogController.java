...
public class DialogController {
	...
	@RequestMapping(value="/secretpw.god", method=RequestMethod.GET)
	public void secretPw(@ModelAttribute("secretWritePw") String secretWritePw, @ModelAttribute("docId") String docId, @ModelAttribute("mapId") String mapId) {
